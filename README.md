...
2.  **Next, you'll want to figure out which promo code** you want to
    apply. We recommend using the first coupon code at the top of this
    page. Again, just click the purple "Show Coupon Code" or "Get Deal"
    button you'll notice a popup with the Quotex discount code chosen.
    Copy that code.
3.  **Now, go back to the first step where you located the promo code
    box** and paste the Quotex coupon code there. Then click the apply
    button!
